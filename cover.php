<!DOCTYPE html>
<html>
<body style="background-image:url(images/bigstock.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> PSLabs </strong>Appointment Booking System</a></li>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:purple">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" action="cover.php">
    ...
    <div class="container">
      ...
      <input type="password" placeholder="Enter Your Password" name="psswrd" required>
...
if (empty($_POST['uname']) || empty($_POST['psswrd'])) {
